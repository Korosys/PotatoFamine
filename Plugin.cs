...
namespace PotatoFamine
{
    public class Plugin : IDalamudPlugin
    {
        ...
        private void ChangeRace(IntPtr customizeDataPtr, Race targetRace)
        {
            ...
            if (this.config.OnlyChangeLalafells && lastWasSelf == false)
            {
        ...
        {
            if (this.config.OnlyChangeLalafells == onlyChangeLalafells)
            {
                return;
            }

            PluginLog.Log($"Only change lalafells players toggled to {onlyChangeLalafells}, refreshing players");
            this.config.OnlyChangeLalafells = onlyChangeLalafells;
